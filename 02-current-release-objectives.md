...
<div class="text-6xl font-bold text-primary mt-8">
  v39.3.0
</div>

<div class="mt-4 text-xl opacity-75">
  Latest Stable Release
</div>

<div class="mt-8">
  <a href="https://atlas-rucio-webui.cern.ch" target="_blank" class="text-lg text-blue-600 dark:text-blue-400 hover:underline">
    https://atlas-rucio-webui.cern.ch
  </a>
</div>
