...
<div class="bg-neutral-100 dark:bg-neutral-800 rounded-xl p-8">
  <div class="mb-4"><span class="i-heroicons-outline-bug-ant w-10 h-10 text-brand-600"/></div>
  <h3 class="font-semibold text-lg text-neutral-900 dark:text-neutral-100">Report Issues & Feedback</h3>
  <p class="text-sm text-neutral-600 dark:text-neutral-400 mt-2 mb-4">Report bugs or request features</p>
  <a href="https://github.com/rucio/webui/issues" target="_blank" class="text-sm font-medium text-brand-600 hover:text-brand-700">github.com/rucio/webui/issues</a>
</div>

<div class="bg-neutral-100 dark:bg-neutral-800 rounded-xl p-8">
  <div class="mb-4"><span class="i-heroicons-outline-chat-bubble-left-right w-10 h-10 text-brand-600"/></div>
  <h3 class="font-semibold text-lg text-neutral-900 dark:text-neutral-100">Join the Community</h3>
  <p class="text-sm text-neutral-600 dark:text-neutral-400 mt-2 mb-4">Connect with the team and other users</p>
  <a href="https://rucio.github.io/documentation/join_rucio_mattermost/" target="_blank" class="text-sm font-medium text-brand-600 hover:text-brand-700">Join Rucio Mattermost</a>
</div>
